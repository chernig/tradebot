...
class Ui_OpenOrd(object):
    def setupUi(self, OpenOrd):
        ...
        self.checkBox_4 = QtWidgets.QCheckBox(OpenOrd)
        ...
        self.checkBox_5 = QtWidgets.QCheckBox(OpenOrd)
    ...
    def retranslateUi(self, OpenOrd):
        ...
        self.checkBox_4.setText(_translate("OpenOrd", "Rate"))
        self.label_5.setText(_translate("OpenOrd", "Limit"))
        self.checkBox_5.setText(_translate("OpenOrd", "Limit"))
