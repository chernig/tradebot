...
if __name__.endswith('__main__'):
    import ema_cross, strategy_linear_regression_channel
    from strategy import strategies_module_name_list
else:
    from strategy import ema_cross, strategy_linear_regression_channel, strategies_module_name_list
